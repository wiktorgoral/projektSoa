...
public interface MiejsceServiceSoap {
    ...
    @Action(input = "http://SOAP/MiejsceServiceSoap/ustawZajeteRequest", output = "http://SOAP/MiejsceServiceSoap/ustawZajeteResponse")
    ...
    @Action(input = "http://SOAP/MiejsceServiceSoap/ustawWolneRequest", output = "http://SOAP/MiejsceServiceSoap/ustawWolneResponse")
